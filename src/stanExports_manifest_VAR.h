...
namespace model_manifest_VAR_namespace {
...
static constexpr std::array<const char*, 163> locations_array__ =
  ...
  " (in 'string', line 18, column 11 to column 36)",
  " (in 'string', line 18, column 2 to column 57)",
  ...
  " (in 'string', line 25, column 11 to column 17)",
...
class model_manifest_VAR final : public model_base_crtp<model_manifest_VAR> {
private:
  int N;
  int TP;
  int N_obs;
...
public:
  ~model_manifest_VAR() {}
  model_manifest_VAR(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_manifest_VAR_namespace::model_manifest_VAR";
    // suppress unused var warning
    (void) function__;
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_manifest_VAR_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_manifest_VAR_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_manifest_VAR_namespace::model_manifest_VAR;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_manifest_VAR_namespace::profiles__;
}
#endif
#endif
