...
#include "stanExports_manifest_AR.h"

RCPP_MODULE(stan_fit4manifest_AR_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_manifest_AR")
