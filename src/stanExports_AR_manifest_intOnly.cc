...
#include "stanExports_AR_manifest_intOnly.h"

RCPP_MODULE(stan_fit4AR_manifest_intOnly_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_AR_manifest_intOnly")
