...
#include "stanExports_manifest_VAR.h"

RCPP_MODULE(stan_fit4manifest_VAR_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_manifest_VAR")
