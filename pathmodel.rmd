...
\begin{tikzpicture}[
    ...
    random_cl/.style = {
      ...
      \node  [latent]  (eta\i wt-1)  [below = 5em of eta\lasti wt-1]  {$\eta_{\i ,t-1}^w$};\foreach \i [remember = \i as \lasti (initially 1)] in {2, ..., 2}
...
\node  [latent]  (phi1_21)  [right = 1em of phi1_12]  {$\phi_{21;(1)}$};
\node  [latent]  (phi1_22)  [right = 1em of phi1_21]  {$\phi_{22;(1)}$};
\node  [latent]  (lnsigma2_1)  [right = 1em of phi1_22]  {log($\pi_{1}$)};
