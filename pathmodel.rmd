...
\node  [manifest]  (y21t)  [right = 1.5em of y12t]  {$y_{21,t}$};
\node  [manifest]  (y22t)  [right = 1.5em of y21t]  {$y_{22,t}$};
\node  [coordinate]  (c1)  at ($(y11t) !0.5! (y12t)$)  {};
\node  [coordinate]  (c2)  at ($(y21t) !0.5! (y22t)$)  {};
...
\begin{tikzpicture}[
    ...
    random_cl/.style = {
      ...
      \foreach \j [remember = \j as \lastj (initially 1)] in {2, ..., 3}
...
\draw  [path, postaction = random_cl, sloped, pos = .2]  (eta1wt-2)  to node  []  {}  (eta2wt);
\draw  [path, postaction = random]  (eta1wt-3.north)  |-  +(0em, 2em) -|  node  []  {$\phi_{11;(3)}$}  (eta1wt.north);
\draw  [path, postaction = random]  (eta1wt-3.north)  |-  +(0em, 2em) -|  node  []  {$\phi_{11;(3)}$}  (eta1wt.north);
\draw  [path, postaction = random_cl, sloped, pos = .2]  (eta1wt-3)  to node  []  {}  (eta2wt);
\draw  [path, postaction = random_cl, sloped, pos = .2]  (eta1wt-3)  to node  []  {}  (eta2wt);
...
\draw  [path, postaction = random, anchor = west]  (eta2wt-2.south)  |-  +(0em, -1em) -|  node  []  {$\phi_{22;(2)}$}  (eta2wt.south);
\draw  [path, postaction = random_cl, sloped, pos = .2]  (eta2wt-3)  to node  []  {}  (eta1wt);
\draw  [path, postaction = random_cl, sloped, pos = .2]  (eta2wt-3)  to node  []  {}  (eta1wt);
\draw  [path, postaction = random, anchor = west]  (eta2wt-3.south)  |-  +(0em, -2em) -|  node  []  {$\phi_{22;(3)}$}  (eta2wt.south);
\draw  [path, postaction = random, anchor = west]  (eta2wt-3.south)  |-  +(0em, -2em) -|  node  []  {$\phi_{22;(3)}$}  (eta2wt.south);
...
\draw  [path, postaction = random]  (eta2wt-2)  to node  []  {$\phi_{22;(1)}$}  (eta2wt-1);
\draw  [path, postaction = random]  (eta1wt-3)  to node  []  {$\phi_{11;(1)}$}  (eta1wt-2);
\draw  [path, postaction = random]  (eta1wt-3)  to node  []  {$\phi_{11;(1)}$}  (eta1wt-2);
\draw  [path, postaction = random_cl, sloped, pos = .2]  (eta1wt-3)  to node  []  {$\phi_{12;(1)}$}  (eta2wt-2);
\draw  [path, postaction = random_cl, sloped, pos = .2]  (eta1wt-3)  to node  []  {$\phi_{12;(1)}$}  (eta2wt-2);
\draw  [path, postaction = random_cl, sloped, pos = .2]  (eta2wt-3)  to node  []  {$\phi_{21;(1)}$}  (eta1wt-2);
\draw  [path, postaction = random_cl, sloped, pos = .2]  (eta2wt-3)  to node  []  {$\phi_{21;(1)}$}  (eta1wt-2);
\draw  [path, postaction = random]  (eta2wt-3)  to node  []  {$\phi_{22;(1)}$}  (eta2wt-2);
\draw  [path, postaction = random]  (eta2wt-3)  to node  []  {$\phi_{22;(1)}$}  (eta2wt-2);
...
\node  [latent]  (phi3_11)  [right = 1em of phi2_12]  {$\phi_{11;(3)}$};
\node  [latent]  (phi3_12)  [right = 1em of phi3_11]  {$\phi_{12;(3)}$};
\node  [latent]  (phi1_21)  [right = 1em of phi3_12]  {$\phi_{21;(1)}$};
...
\node  [latent]  (phi3_21)  [right = 1em of phi2_22]  {$\phi_{21;(3)}$};
\node  [latent]  (phi3_22)  [right = 1em of phi3_21]  {$\phi_{22;(3)}$};
\node  [latent]  (lnsigma2_1)  [right = 1em of phi3_22]  {log($\pi_{1}$)};
...
\node  [coordinate]  (c7)  [above = 2em of phi3_11]  {};
\node  [coordinate]  (c8)  [above = 2em of phi3_12]  {};
\node  [coordinate]  (c9)  [above = 2em of phi1_21]  {};
\node  [coordinate]  (c10)  [above = 2em of phi1_22]  {};
\node  [coordinate]  (c11)  [above = 2em of phi2_21]  {};
\node  [coordinate]  (c12)  [above = 2em of phi2_22]  {};
\node  [coordinate]  (c13)  [above = 2em of phi3_21]  {};
\node  [coordinate]  (c14)  [above = 2em of phi3_22]  {};
\node  [coordinate]  (c15)  [above = 2em of lnsigma2_1]  {};
\node  [coordinate]  (c16)  [above = 2em of lnsigma2_2]  {};
\node  [coordinate]  (c17)  [above = 2em of lnsigma_12]  {}; \draw  [path]  (c1)  to node  []  {}  (etaB_1);
...
\draw  [path]  (c7)  to node  []  {}  (phi3_11);
\draw  [path]  (c8)  to node  []  {}  (phi3_12);
\draw  [path]  (c9)  to node  []  {}  (phi1_21);
\draw  [path]  (c10)  to node  []  {}  (phi1_22);
\draw  [path]  (c11)  to node  []  {}  (phi2_21);
\draw  [path]  (c12)  to node  []  {}  (phi2_22);
\draw  [path]  (c13)  to node  []  {}  (phi3_21);
\draw  [path]  (c14)  to node  []  {}  (phi3_22);
\draw  [path]  (c15)  to node  []  {}  (lnsigma2_1);
\draw  [path]  (c16)  to node  []  {}  (lnsigma2_2);
\draw  [path]  (c17)  to node  []  {}  (lnsigma_12); \draw  [thick]  (c1)  --  (c17);
% caption
