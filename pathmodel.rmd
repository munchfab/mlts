...
\draw  [thick]  (c1) -- (c9) {};
\draw  [path]  (c1.north) to node [] {} (mu_1);
\draw  [path]  (c2.north) to node [] {} (mu_2);
\draw  [path]  (c3.north) to node [] {} (phi_11);
\draw  [path]  (c4.north) to node [] {} (phi_12);
\draw  [path]  (c5.north) to node [] {} (phi_21);
\draw  [path]  (c6.north) to node [] {} (phi_22);
\draw  [path]  (c7.north) to node [] {} (lnsigma2_1);
\draw  [path]  (c8.north) to node [] {} (lnsigma2_2);
\draw  [path]  (c9.north) to node [] {} (lnsigma_12);
