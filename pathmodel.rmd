...
\node  [coordinate]  (cpred1)  [below = 5em of mu_1]  {};
\node  [coordinate]  (cpred9)  [below = 5em of lnsigma_12]  {};
\node  [manifest]  (x)  at  ($(cpred1)!1/4!(cpred9)$)  {\textit{x}};
\node  [manifest]  (z)  at  ($(cpred1)!2/4!(cpred9)$)  {\textit{z}};
\node  [manifest]  (y)  at  ($(cpred1)!3/4!(cpred9)$)  {\textit{y}};
